            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown"><a href="#" class="dropdown-toggle"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="/NursingLevelServlet/add">查询护理级别</a></li>
                    </ul></li>
                <li class="dropdown"><a href="#" class="dropdown-toggle"
                                        data-toggle="dropdown" role="button" aria-haspopup="true"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="/NursingRecordServlet/add">查询护理记录</a></li>
                    </ul>
                </li>
                ...
                <li class="dropdown"><a href="#" class="dropdown-toggle"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="/BedServlet/add">查询床位内容</a></li>
                    </ul>
                </li>
                ...
                <li class="dropdown"><a href="#" class="dropdown-toggle"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="/FoodRecordServlet/add">查询膳食记录</a></li>
                    </ul>
                </li>
                <li class="dropdown"><a href="#" class="dropdown-toggle"
                                        data-toggle="dropdown" role="button" aria-haspopup="true"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="/CustomerCheckInServlet/add">查询入住登记</a></li>
                    </ul>
                </li>
                <li class="dropdown"><a href="#" class="dropdown-toggle"
                                        data-toggle="dropdown" role="button" aria-haspopup="true"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="/CustomerCheckOutServlet/add">查询退住登记</a></li>
                    </ul>
                </li>
                <li class="dropdown"><a href="#" class="dropdown-toggle"
                                        data-toggle="dropdown" role="button" aria-haspopup="true"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="/CustomerGoOutServlet/add">查询外出登记</a></li>
                    </ul>
                </li>
...
<form  action="/NursingLevelServlet/add"
       method="post">
    <!--表单元素-->
    id:<input
