...
<h3>修改入住信息</h3>
<form action="/CustomerCheckInServlet/update" method="post">

    <%--隐藏域，提交id--%>
    <input type="hidden" name="id" value="${customercheckin.id}">

        床位号：<input name="bedId" value="${customercheckin.bedId}"><br>
        入住时间：<input name="checkInDate" value="${customercheckin.checkInDate}"><br>
        到期时间:<input name="expirationDate" value="${customercheckin.expirationDate}"><br>
        客户Id:<input name="customerId" value="${customercheckin.customerId}"><br>

    注意事项：<textarea rows="5" cols="20" name="description">${customercheckin.attention} </textarea><br>
