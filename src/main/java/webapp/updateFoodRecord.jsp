...
<h3>修改膳食信息</h3>
<form action="/FoodRecordServlet/update" method="post">

    <%--隐藏域，提交id--%>
    <input type="hidden" name="id" value="${foodrecord.id}">

    食物：<input name="food" value="${foodrecord.food}"><br>
    食物Id：<input name="foodId" value="${foodrecord.foodId}"><br>
