...
<h3>添加外出信息</h3>
<form  action="/CustomerGoOutServlet/add"
       method="post">
    <!--表单元素-->
    id:<input
        type="text" name=id id="id"><br>
    外出原因:<input
        type="text" name="outGoingReason" id="outGoingReason" /><br />
    外出时间:<input
        type="text" name="outGoingTime" id="outGoingTime" /><br />
    预期返回时间:<input
        type="text" name="expectedReturnTime" id="expectedReturnTime" /><br />
    实际返回时间:<input
        type="text" name="actualReturnTime" id="actualReturnTime" /><br />
    陪同人:<input
        type="text" name="escort" id="escort" /><br />
    陪同人电话:<input
        type="text" name="escortTel" id="escortTel" /><br />
    外出用户Id:<input
        type="text" name="customerId" id="customerId" /><br />
