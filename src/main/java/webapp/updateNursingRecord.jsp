...
<h3>修改护理记录</h3>
<form action="/NursingRecordServlet/update" method="post">

    <%--隐藏域，提交id--%>
    <input type="hidden" name="id" value="${nursingrecord.id}">

    内容：<input name="content" value="${nursingrecord.content}"><br>
    开始时间：<input name="start" value="${nursingrecord.start}"><br>
    结束时间：<input name="end" value="${nursingrecord.end}"><br>
    使用者Id：<input name="userId" value="${nursingrecord.userId}"><br>
    等级Id：<input name="levelId" value="${nursingrecord.levelId}"><br>
        状态：
