...
<h3>添加入住信息</h3>
<form  action="/CustomerCheckInServlet/add"
       method="post">
    <!--表单元素-->
    id:<input
        type="text" name=id id="id"><br>
    床位Id:<input
        type="text" name="bedId" id="bedId" /><br />
    入住时间:<input
        type="text" name="checkInDate" id="checkInDate" /><br />
    到期时间:<input
        type="text" name="expirationDate" id="expirationDate" /><br />
    注意事项:<input
        type="text" name="attention" id="attention" /><br />
    用户Id:<input
