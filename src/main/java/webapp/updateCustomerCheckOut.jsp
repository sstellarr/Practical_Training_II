...
<h3>修改退住信息</h3>
<form action="/CustomerCheckOutServlet/update" method="post">

    <%--隐藏域，提交id--%>
    <input type="hidden" name="id" value="${customercheckout.id}">

        退房时间：<input name="retreatTime" value="${customercheckout.retreatTime}"><br>
        退房原因：<input name="retreatReason" value="${customercheckout.retreatReason}"><br>
        申请时间:<input name="askTime" value="${customercheckout.askTime}"><br>
        监护人:<input name="auditPerson" value="${customercheckout.auditPerson}"><br>
        监护人意见:<input name="auditOpinion" value="${customercheckout.auditOpinion}"><br>
        退房客户Id:<input name="retreatId" value="${customercheckout.retreatId}"><br>



    注意事项：<textarea rows="5" cols="20" name="description">${customercheckout.attention} </textarea><br>
