...
<form  action="/CustomerServlet/add"
       method="post">
  <!--表单元素-->
  id:<input
  ...
  身份证号:<input
        type="text" name="idCardNumber" id="idCardNumber" /><br />
  档案编号:<input
        type="text" name="fileNumber" id="fileNumber" /><br />
  用户名:<input
        type="text" name="account" id="account" /><br />
  密码:<input
        type="text" name="password" id="password"><br>
  身高:<input
        type="text" name="height" id="height" /><br />
  生日:<input
        type="text" name="birthday" id="birthday" /><br />
