...
<h3>修改护理级别</h3>
<form action="/NursingLevelServlet/update" method="post">

    <%--隐藏域，提交id--%>
    <input type="hidden" name="id" value="${nursinglevel.id}">

    等级名称：<input name="name" value="${nursinglevel.name}"><br>

    启用状态：
    <c:if test="${nursinglevel.status == 0}">
