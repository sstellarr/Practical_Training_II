...
<table border="1" cellspacing="0" width="500">
    ...
    <c:forEach items="${customercheckouts}" var="customercheckout" varStatus="customercheckoutstatus">
        <tr >

            <td>${customercheckoutstatus.count}</td>
            <td>${customercheckout.retreatTime}</td>
            <td>${customercheckout.retreatReason}</td>
            <td>${customercheckout.askTime}</td>
            <td>${customercheckout.auditPerson}</td>
            <td>${customercheckout.auditOpinion}</td>
            <td>${customercheckout.retreatId}</td>




            <td><a href="/CustomerCheckOutServlet/selectById?id=${customercheckout.id}">修改</a>
                <a href="/CustomerCheckOutServlet/deleteById?id=${customercheckout.id}">删除</a></td>
        </tr>
    </c:forEach>
</table>
