...
<form  action="/NursingRecordServlet/add"
       method="post">
    <!--表单元素-->
    id:<input
    ...
    开始时间:<input
        type="text" name="start" id="start" /><br />
    结束时间:<input
        type="text" name="end" id="end" /><br />
    用户Id:<input
        type="text" name="userId" id="userId" /><br />
    等级Id:<input
        type="text" name="levelId" id="levelId" /><br />
