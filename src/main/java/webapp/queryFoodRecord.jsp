...
<table border="1" cellspacing="0" width="500">
    ...
    <c:forEach items="${foodrecords}" var="foodrecord" varStatus="foodrecordstatus">
        <tr >

            <td>${foodrecordstatus.count}</td>
            <td>${foodrecord.food}</td>
            <td>${foodrecord.foodId}</td>



            <td><a href="/FoodRecordServlet/selectById?id=${foodrecord.id}">修改</a>
                <a href="/FoodRecordServlet/deleteById?id=${foodrecord.id}">删除</a></td>
        </tr>
    </c:forEach>
</table>
