...
<table border="1" cellspacing="0" width="500">
    ...
    <c:forEach items="${staffs}" var="staff" varStatus="staffstatus">
        <tr >

            <td>${staffstatus.count}</td>
            <td>${staff.name}</td>
            <td>${staff.gender}</td>
            <td>${staff.ID}</td>
            <td>${staff.type}</td>
            ...
            <td><a href="/StaffServlet/selectById?id=${staff.id}">修改</a>
                <a href="/StaffServlet/deleteById?id=${staff.id}">删除</a></td>
        </tr>
    </c:forEach>
</table>
