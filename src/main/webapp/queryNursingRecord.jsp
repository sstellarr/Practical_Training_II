...
<table border="1" cellspacing="0" width="500">
    ...
    <c:forEach items="${nursingrecords}" var="nursingrecord" varStatus="nursingrecordstatus">
        <tr >

            <td>${nursingrecordstatus.count}</td>
            <td>${nursingrecord.content}</td>
            <td>${nursingrecord.start}</td>
            <td>${nursingrecord.end}</td>
            <td>${nursingrecord.userId}</td>
            <td>${nursingrecord.levelId}</td>


            <td><a href="/NursingRecordServlet/selectById?id=${nursingrecord.id}">修改</a>
                <a href="/NursingRecordServlet/deleteById?id=${nursingrecord.id}">删除</a></td>
        </tr>
    </c:forEach>
</table>
