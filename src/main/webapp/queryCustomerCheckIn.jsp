...
<table border="1" cellspacing="0" width="500">
    ...
    <c:forEach items="${customercheckins}" var="customercheckin" varStatus="customercheckinstatus">
        <tr >

            <td>${customercheckinstatus.count}</td>
            <td>${customercheckin.bedId}</td>
            <td>${customercheckin.checkInDate}</td>
            <td>${customercheckin.expirationDate}</td>
            <td>${customercheckin.attention}</td>
            <td>${customercheckin.customerId}</td>


            <td><a href="/CustomerCheckInServlet/selectById?id=${customercheckin.id}">修改</a>
                <a href="/CustomerCheckInServlet/deleteById?id=${customercheckin.id}">删除</a></td>
        </tr>
    </c:forEach>
</table>
