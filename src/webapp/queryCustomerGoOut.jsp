...
<table border="1" cellspacing="0" width="500">
    ...
    <c:forEach items="${customergoouts}" var="customergouout" varStatus="customergououtstatus">
        <tr >

            <td>${customergououtstatus.count}</td>
            <td>${customergouout.roomoutGoingReasonId}</td>
            <td>${customergouout.outGoingTime}</td>
            <td>${customergouout.expectedReturnTime}</td>
            <td>${customergouout.actualReturnTime}</td>
            <td>${customergouout.escort}</td>
            <td>${customergouout.escortTel}</td>
            <td>${customergouout.customerId}</td>


            <td><a href="/CustomerGoOutServlet/selectById?id=${customergouout.id}">修改</a>
                <a href="/CustomerGoOutServlet/deleteById?id=${customergouout.id}">删除</a></td>
        </tr>
    </c:forEach>
</table>
